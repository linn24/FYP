...
public abstract class PredictionsPanel extends JPanel {
	...
	public class PredictionTab extends JPanel {//protected
	...
	protected class GoldStandardPredictionPanel extends JPanel {
		...
		protected JComboBox goldStandardsComboBox_;
		protected JComboBox predictionsComboBox_;
		...
		public GoldStandardPredictionPanel() {
			...
			goldStandardsComboBox_ = new JComboBox();
			panel.add(goldStandardsComboBox_);

			predictionsComboBox_ = new JComboBox();
